...
const getSeatsByTrip = catchAsync((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const reserveSeat = catchAsync((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let { tripId, seatNo, sessionToken } = req.body;
    if (!sessionToken)
        sessionToken = uuidv4();
    let seat = yield seatService.createSeat({ tripId, seatNo }, { tripId, seatNo, sessionToken });
    if (!seat)
        throw new UnauthorizedError('Unable to reserve seat');
    seat.status = SeatStatus.RESERVED;
    const isCached = cache.has(seat.id);
    if (isCached)
        throw new CacheAPIError('Seat already reserved');
